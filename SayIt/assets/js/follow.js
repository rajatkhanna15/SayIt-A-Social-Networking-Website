$(function()
{
  $('.follow-btn').click(function(){
    ...
    if ($button.hasClass('following-btn')) {
      $.post('http://localhost/php projects/SayIt/core/ajax/follow.php', {unfollow:followID, profile:profile}, function(data){
    ...
    {
      $.post('http://localhost/php projects/SayIt/core/ajax/follow.php', {follow:followID, profile:profile}, function(data){
        data = JSON.parse(data);
