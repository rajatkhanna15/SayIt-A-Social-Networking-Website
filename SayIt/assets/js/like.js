$(function()
{
	$(document).on('click','.like-btn', function()
	{
		...
		$.post('http://localhost/php projects/SayIt/core/ajax/like.php', {like:tweet_id, user_id:user_id}, function()
		{
 			counter.show();
	...
	$(document).on('click','.unlike-btn', function()
	{
		...
		$.post('http://localhost/php projects/SayIt/core/ajax/like.php', {unlike:tweet_id, user_id:user_id}, function()
		{
 			counter.show();
