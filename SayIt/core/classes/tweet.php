...
class Tweet extends User{
	      ...
	      echo '<div class="all-tweet">
			      <div class="t-show-wrap">
			       ...
			       '.((!empty($retweet) ? $retweet['retweetID'] === $tweet->retweetID OR $tweet->retweetID > 0 : '' ) ? '
			        ...
			        '.((!empty($retweet) ? !empty($tweet->retweetMsg) && $tweet->tweetID === $retweet['tweetID'] or $tweet->retweetID > 0 : '' ) ? '<div class="t-show-head">
	...
	public static function getTweetLinks($tweet)
	{
		...
		$tweet = preg_replace("/#([\w]+)/", "<a href='http://localhost/php projects/SayIt/hashtag/$1'>$0</a>", $tweet);		
		$tweet = preg_replace("/@([\w]+)/", "<a href='http://localhost/php projects/SayIt/$1'>$0</a>", $tweet);
		return $tweet;		
	}
