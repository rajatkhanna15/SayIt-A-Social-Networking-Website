...
<html>
	<head>
		<title>#<?php echo $hashtag;?> Hashtag on SayIt</title>
		<meta charset="UTF-8" />
   			...
   			echo '<div class="all-tweet">
					<div class="t-show-wrap">	
					 <div class="t-show-inner">
   							'.((!empty($retweet) ? $retweet['retweetID'] === $tweet->retweetID or $tweet->retweetID > 0 : '') ? ' 
							...
							<div class="t-s-head-content">
								<div class="t-h-c-name">
									...
									<span>'.(!empty($retweet) ? $getFromT->timeAgo($retweet['postedOn']) : '').'</span>
								</div>
								<div class="t-h-c-dis">
						...
						<div class="t-show-footer">
							<div class="t-s-f-right">
								...
								'.(($getFromU->loggedIn()) ?   '
									<li><button><i class="fa fa-share" aria-hidden="true"></i></button></li>	
									<li>'.((!empty($retweet) ? $tweet->tweetID === $retweet['retweetID'] OR $user_id === $retweet['retweetBy'] : '') ? '<button class="retweeted" data-tweet="'.$tweet->tweetID.'" data-user="'.$tweet->tweetBy.'"><i class="fa fa-retweet" aria-hidden="true"></i><span class="retweetsCount">'.(($tweet->retweetCount > 0) ? $tweet->retweetCount : '').'</span></button>' : '<button class="retweet" data-tweet="'.$tweet->tweetID.'" data-user="'.$tweet->tweetBy.'"><i class="fa fa-retweet" aria-hidden="true"></i><span class="retweetsCount">'.(($tweet->retweetCount > 0) ? $tweet->retweetCount : '').'</span></button>').'</li>
									<li>'.((!empty($likes) ? $likes['likeOn'] == $tweet->tweetID : '') ? 
